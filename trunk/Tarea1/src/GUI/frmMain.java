...
private void CargarDatos(){
        cc.altaCliente("costas", "gcostas@gmail.com", "Gerardo", "Av. Italia 2078", "Costas", new DataFecha(15, 11, 1983), ruta + "francesc_font_2.jpg");
        cc.altaCliente("roro", "rcotelo@yahoo.com ", "Rodrigo", "Pdte. Berro 1548", "Cotelo", new DataFecha(2, 8, 1975), ruta + "40-300x237.jpg");
        cc.altaCliente("chechi", "cgarrido@hotmail.com", "Cecilia", "Gral. Urquiza 1548", "Garrido", new DataFecha(12, 9, 1987),ruta + "542179_374050182661087_570456924_n.jpg");
        cc.altaCliente("andy", "agarcia@gmail.com", "Andrea", "Dr. Manuel Albo 4512", "García", new DataFecha(28, 07, 1951), ruta + "98871376.jpg");
        cc.altaCliente("weiss", "aweiss@hotmail.com ", "Adrian", "Monte Caseros 5615", "Weiss", new DataFecha(23, 12, 1978), ruta + "362540d2-e952-48c3-bbea-87e4836415a1.jpg");
        ...
        Set<String> imgs1 = new HashSet<>();
        imgs1.add(ruta + "BARROSSELL.png");
        imgs1.add(ruta + "bar-rossell-logo.jpg");        
        cr.altaRestaurante("rossell", "bar.rossel@gmail.com", "Bar Rossell", "Bvar. Artigas 1601", imgs1);
        
        Set<String> imgs2 = new HashSet<>();
        imgs2.add(ruta + "bocatti-empanadas.jpg");
        imgs2.add(ruta + "10259932_748842808489816_4942781320214052509_n.jpg");
        imgs2.add(ruta + "10388594_755411944499569_8836515887985101946_n.png");        
        cr.altaRestaurante("bocatti", "bocatti@gmail.com", "Empanadas Bocatti", "18 de julio 2138", imgs2);
        
        Set<String> imgs3 = new HashSet<>();
        imgs3.add(ruta + "wok-in-box.jpg");
        imgs3.add(ruta + "wokboxrestaurant.jpg");        
        ...
        cr.altaIndividual("mera", "Milanesa de Carne", "Con lechuga, tomate, mayonesa y fritas", 180, ruta + "milanesa-con-fritas.jpg");
        cr.altaIndividual("mera", "Chivito canadiense", "Lomito, jamón, muzza, tomate, aceitunas, panceta, huevo, morrón y fritas", 305, ruta + "chivito.jpg");
        ...
        cr.altaIndividual("rossell", "Milanesa a caballo", "Milanesa con dos huevos fritos acompañado de fritas", 270, ruta + "215751-sabores450-thumb.jpg");
        cr.altaIndividual("rossell", "Pizza con 2 gustos", "Pizza con dos gustos a elección", 103, "");
        cr.altaIndividual("rossell", "Agnolotis", "Agnolotis de jamón y queso", 225, ruta + "sorrentinos-caprese.jpg");
        cr.altaIndividual("bocatti", "Empanada de Carne", "Carne, aceitunas, huevo duro, condimentos", 44, ruta + "empanada_argentina.jpg");
        cr.altaIndividual("bocatti", "Empanada Americana", "Carne, panceta y huevo duro", 44, "");
        cr.altaIndividual("bocatti", "Empanada QyC", "Empanada de Queso y Cebolla", 44, ruta + "cebollayqueso.jpg");
        cr.altaIndividual("bocatti", "Empanada Capresse", "Queso, tomate y albahaca", 44, ruta + "Caprese.jpg");
        cr.altaIndividual("winb", "Thai wok", "Cerdo, calamares, sweet chili, salsa de ostras, maní y jugo de lima, acompañado de tallarines o arroz.", 240, ruta + "wok-verduras-thai-contoque-paprika-300x171.jpg");
        ...
        cr.altaIndividual("winb", "Classic wok de pollo", "Pollo, vegetales mixtos, salsa agridulce, salsa de soja y cebollita de verdeo, acompañado de tallarines o arroz.", 230, ruta + "images.jpg");
