...
public class RegistrarCliente extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.add(rcTxtNick1, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 60, 281, -1));
        ...
        jPanel1.add(rcTxtEmail1, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 85, 281, -1));
        jPanel1.add(rcTxtNombre1, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 110, 281, -1));
        jPanel1.add(rcTxtApellido1, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 135, 281, -1));
        jPanel1.add(rcTxtDireccion1, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 160, 281, -1));
        ...
        jPanel1.add(jLabel21, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 135, -1, -1));

        jLabel14.setText("Nombre:");
        jPanel1.add(jLabel14, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 110, -1, -1));

        jLabel13.setText("Correo Electrónico:");
        jPanel1.add(jLabel13, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 85, -1, -1));
        ...
        jPanel1.add(jLabel9, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 30, 244, -1));
    ...
    private void rcBtnRegistrar1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_rcBtnRegistrar1ActionPerformed
        if (!cc.altaCliente(rcTxtNick1.getText(), rcTxtEmail1.getText(), rcTxtNombre1.getText(), rcTxtDireccion1.getText(), rcTxtApellido1.getText(), new DataFecha((int) rcCmbAnio1.getSelectedItem(), (int) rcCmbMes1.getSelectedItem(), (int) rcCmbDia1.getSelectedItem()), imagenSeleccionada)) {
