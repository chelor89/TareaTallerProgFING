...
<%@page import="publicar.DataPedidoArray"%>
<%@page import="publicar.DataComentario"%>
<%@page import="publicar.DataPedido"%>
<%@page import="publicar.DataCliente"%>
<%@page import="java.util.List"%>
<%@page import="publicar.DataProducto"%>
    ...
    <head>
        ...
        <script>
            ...
            function generarMod(prod){
                    ...
                    //Pide la imagen del producto seleccionado al servidor
            ...
            //Operaciones para manejar el pedido
            ...
            function addProducto( nombre, cantidad){
                var req = new XMLHttpRequest();
                req.open("GET","restaurantes?tipo=addProducto&producto=" + nombre + "&cantidad=" + cantidad + "&restaurante=<%=dr.getNick()%>",true);
                req.send();
                req.onreadystatechange=function(){
                    if (req.readyState===4 && req.status===200){
                        getPedido();
        ...
        <%  DataCliente cli = Sesion.getInfoClienteLogueado(request);
            String Direccion;
            if (cli != null) 
                    ...
                    <div class="tab-content container-fluid">
                        <div class="tab-pane fade active in" id="menu">
                            <%
                                ...
                                List<DataProducto> promos = dr.getPromociones();
                                if(!promos.isEmpty()){
                            %>
                            <div class="row">
                                <h1>Promociones</h1>
                                    ...
                                    <div class="col-lg-6" style="padding: 0.6%">
                                        <a id="<%= p.getNombre()%>" style="cursor: pointer" class="list-group-item datosProd">
                                            <div class="pull-right"><span class="lead">$</span><span class="lead precio"><%= p.getPrecio()%></span></div>
                            ...
                            <% 
                                ...
                                List<DataProducto> ind = dr.getIndividuales();
                                if (!ind.isEmpty()){
                            %>        
                                ...
                                <h1>Individuales</h1>
                                    ...
                                    <div class="col-lg-6" style="padding: 0.6%">
                                        <a  style="cursor: pointer" class="list-group-item datosProd">
                                            <div class="pull-right"><span class="lead">$</span><span class="lead precio"><%= i.getPrecio()%></span></div>
                        ...
                        <div class="tab-pane fade" id="informacion">
                            <div class="row">
                                <div class="col-lg-12">
                                    ...
                                    <div id="carousel-example-generic" class="carousel slide col-lg-5" data-ride="carousel">
                                        ...
                                        <% for (int i=1;i<dr.getImagenes().size();i++){ %>
                            ...
                            <% 
                            DataPedidoArray pedidos = (DataPedidoArray) request.getAttribute("pedidos"); 
                            %>
                            <div class="row">
                                <div class="col-lg-12">
                                        ...
                                        %>
                                            <% if (comentario != null) { %>
                                                <tr>
                                                    ...
                                                    <%DataFecha fe = comentario.getFecha();%>
                                                    <td> <%=fe.getDia()%>/<%=fe.getMes()%>/<%=fe.getAnio()%> </td>
                                            </tr>                               
                                            <% } %>
                                        <% } %>
                                    </table>
