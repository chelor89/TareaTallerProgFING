            ...
            <div class="col-lg-10">
                <div class="row">
                    ...
                    <div class="col-lg-6 pull-right text-right">
                        ...
                        <span style="display:block" class="blanco"><%= cli.getMail()%></span><a style="display:block" href="/cerrarSesion">Cerrar Sesion</a>
                    </div>
                </div>
                ...
                <div class="col-lg-7 pull-right">
                    <form class="form-inline pull-right" role="form" method="POST" action="login">    
                        <div class="form-group">
                            <input type="text" name="login" class="form-control" placeholder="Email o Nickname">
                        </div>
                        <div class="form-group ">
...
//    $("#mReg").click({$('#registrationForm').data('bootstrapValidator').resetForm();});
//    $("#myModal").on('show', function(){$('#registrationForm').data('bootstrapValidator').resetForm(); });
</script>