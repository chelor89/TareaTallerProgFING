...
public class RegistrarCliente extends javax.swing.JInternalFrame {
    ...
    private void rcBtnRegistrar1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_rcBtnRegistrar1ActionPerformed
        if (!cc.altaCliente(rcTxtNick1.getText(), rcTxtEmail1.getText(), rcTxtNombre1.getText(), rcTxtDireccion1.getText(), rcTxtApellido1.getText(), new DataFecha((int) rcCmbAnio1.getSelectedItem(), (int) rcCmbMes1.getSelectedItem(), (int) rcCmbDia1.getSelectedItem()),rcTxtContra.getText(), imagenSeleccionada)) {
