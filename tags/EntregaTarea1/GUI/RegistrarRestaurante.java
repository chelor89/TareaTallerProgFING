...
public class RegistrarRestaurante extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(jLabel10, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 75, -1, -1));

        jLabel11.setText("Nombre:");
        getContentPane().add(jLabel11, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 100, -1, -1));

        jLabel12.setText("Direccion:");
        getContentPane().add(jLabel12, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 125, -1, -1));
        ...
        getContentPane().add(RestoNick, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 50, 224, -1));
        ...
        getContentPane().add(ComboCat, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 190, 160, -1));
        getContentPane().add(RestoMail, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 75, 224, -1));

        jLabel14.setText("Selecciona al menos una de las siguientes categorias:");
        getContentPane().add(jLabel14, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 170, 340, -1));
        getContentPane().add(RestoNom, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 100, 224, -1));
        ...
        getContentPane().add(jButton3, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 220, 140, -1));
        ...
        getContentPane().add(RestoDir, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 125, 224, -1));

        jLabel9.setText("NickName:");
        getContentPane().add(jLabel9, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 51, -1, -1));

        jScrollPane1.setViewportView(lstCategorias);

        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 250, 160, -1));
        ...
        getContentPane().add(btnAgregarCat, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 220, 160, -1));

        jScrollPane2.setViewportView(lstImagenes);

        getContentPane().add(jScrollPane2, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 250, 210, -1));
    ...
    private void btnRegistrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRegistrarActionPerformed
        if(!RestoNick.getText().equals("") && !RestoMail.getText().equals("") && !RestoDir.getText().equals("") && 
            !RestoNom.getText().equals("")){
            
            if(lstCategorias.getModel().getSize() != 0){
                if (!cr.altaRestaurante( RestoNick.getText(),RestoMail.getText() ,RestoNom.getText() ,RestoDir.getText() , imagenes)){
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        if(seleccion==JFileChooser.APPROVE_OPTION){
            ...
            for (int i=0; i<files.length; i++) {
                ...
                imagenes.add(files[i].getAbsolutePath());                
                lm.addElement(files[i].getAbsolutePath());
